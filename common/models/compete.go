...
type Compete struct {
	...
	Extra                interface{}   `gorm:"column:extra;type:json;default:'{}';comment:'额外字段'" json:"extra"`
	...
	ShowPlatform         []int         `gorm:"column:showPlatform;type:json;not null;default:'[]';comment:'展示平台: 1.edu'" json:"showPlatform"`
